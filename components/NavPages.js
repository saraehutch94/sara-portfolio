...
function NavPages() {
    ...
    return (
        ...
        <nav className={styles.navfull}>
            <div className="hidden md:flex md:justify-end items-center h-full lg:space-x-20 space-x-10 mr-6">
                <Link href="/" passHref><div className="mr-auto ml-6 cursor-pointer"><LogoNav /></div></Link>
        ...
        <div className={mobMenuState ? "flex flex-col w-full bg-navDarkGreen text-xl z-10 md:hidden" : "hidden"}>
