...
function Nav() {
    ...
    return (
        ...
        <nav className="bg-slate-600 h-14 w-full">
            <div className="hidden md:flex md:justify-center items-center h-full lg:space-x-20 space-x-10 mr-8">
            ...
            <div className="md:hidden flex h-full justify-end items-center mr-4">
                <svg xmlns="http://www.w3.org/2000/svg"  onClick={changeMobMenuState} className="h-7 w-7 cursor-pointer text-green-500 hover:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h16M4 18h16" /></svg>
            </div>
        </nav>
