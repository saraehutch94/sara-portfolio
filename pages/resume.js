                        ...
                        <div className="mb-9">
                            ...
                            <div className="mb-8">
                                ...
                                <ul>
                                    ...
                                    <li className="mb-1 ml-8"><span className="font-semibold">Marvel Mania</span> (GitHub | Netlify) – Front-end web application built with HTML, CSS and JavaScript, querying the Marvel API</li>
                                    <li className="mb-1 ml-8"><span className="font-semibold">Vino Italiano</span> (GitHub | Heroku) – Full-CRUD back-end web application built with Node.js, MongoDB, Mongoose, Express and Bcrypt</li>
                                    <li className="mb-1 ml-8"><span className="font-semibold">Sarify</span> (Front-end: GitHub | Netlify | Back-end: GitHub | Heroku) – MERN-stack web application built using MongoDB, Express, React, Node.js, and Mongoose</li>
                                    <li className="mb-1 ml-8"><span className="font-semibold">DS<sup>2</sup></span> (GitHub | Heroku) – Full-stack Django application built with Django, Python and PostgreSQL, querying the LyricsGenius API</li>
                                </ul>
                            </div>
                            <div className="mb-2">
